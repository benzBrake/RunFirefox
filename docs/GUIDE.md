...
3. 解压浏览器文件后，在启动器设置中手动选择浏览器主程序。未列出专用类型的 Firefox 衍生版请选择“其他 Firefox 衍生版”，其他 Chromium 系浏览器请选择“其他 Chromium 浏览器”。

这两个通用类型只提供对应内核的便携配置和启动能力，不提供版本查询、内置下载或 RunFirefox 托管更新。“其他 Firefox 衍生版”仍可通过设置中的自动更新开关控制浏览器自身更新，但不会修改衍生版自己的更新通道。
